                              ...
                              <div>
                                ...
                                >
                                  <div class="flex items-center gap-3">
                                    ...
                                    @endphp
                                    <div
                                      class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gradient-to-r {{ $colors[$archive->research_agenda->id] ? $colors[$archive->research_agenda->id]  : 'from-slate-300 to-slate-400 text-slate-400' }} tracking-[-0.4px]"
                                    >
