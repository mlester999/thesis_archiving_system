...
>
    ...
    @else
        <button {{ $attributes->except('class') }} class="flex items-center space-x-1 text-left text-xs sm:text-sm leading-4 font-medium text-slate-800 tracking-widest group focus:outline-none">
            <span>{{ $slot }}</span>
