    ...
    <body class="body-bg h-screen bg-slate-600 overflow-hidden antialiased">
        <nav class="bg-green-600 h-24 w-full border-b-8 border-yellow-500">
            ...
            <div class="w-full min-h-screen p-6 absolute z-20">
                ...
                <div class="outline outline-white outline-1 w-11/12 md:w-5/6 2xl:w-5/6 absolute top-1/3 mt-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2 backdrop-blur-md bg-white/30 rounded-lg md:p-20 p-10">
