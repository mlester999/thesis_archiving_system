...
<div class="overflow-hidden bg-white shadow-xl sm:rounded-lg max-w-6xl mx-auto mt-8 relative">
    <div class="px-4 py-5 sm:px-6">
      ...
      <a href="{{ route('archives') }}" class="px-4 py-3 bg-gray-500 hover:bg-opacity-80 duration-150 text-white absolute right-44 top-4"><i class="fa-solid fa-box-archive fa-lg text-white duration-200 mr-1"></i> My Archives</a>
      <a href="{{ route('edit.profile') }}" class="px-4 py-3 bg-green-500 hover:bg-opacity-80 duration-150 text-white absolute right-6 top-4"><i class="fa-solid fa-pen-to-square fa-lg text-white duration-200 mr-1"></i> Edit Profile</a>
