<div class="w-full px-6 pb-6 h-screen overflow-y-auto">
	...
	<div class="flex-1 min-w-0 py-2">
		<p class="pb-6 pt-3 font-bold uppercase text-sm leading-7 tracking-wider text-gray-600"><span class="flex items-center gap-1"> <x-ri-home-3-fill class="w-4 h-4" /> Home<x-heroicon-o-arrow-long-right class="w-5 h-6" />Maintenance<x-heroicon-o-arrow-long-right class="w-5 h-6" />Admin Users List</span></p>
	</div>
	  ...
	  <table class="min-w-full border-separate divide-y divide-gray-200 border-b-2 shadow">
		<thead class="bg-gray-50 whitespace-nowrap">
		  ...
		  >
			...
			<th class="font-semibold text-center px-4 text-gray-700 uppercase tracking-normal">Role Name 
			...
			<th class="font-semibold text-center px-4 text-gray-700 uppercase tracking-normal">Username 
			...
			<th class="font-semibold text-center px-4 text-gray-700 uppercase tracking-normal">Email Address 
		  ...
		  >
			...
			<td class="px-8 whitespace-nowrap">
				<div class="flex justify-center space-x-2">
					...
					<button wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed" wire:click="edit({{ $user->id }})" class="cursor-pointer fa-solid fa-pen-to-square text-blue-500 hover:text-opacity-70 duration-150 fa-xl"></button>
		...
		>
		  <td colspan="7" class="px-4">
			<div class="flex items-center justify-center">
			  <div>
				<p class="text-md sm:text-lg py-8 font-medium leading-none text-gray-400">No users found...</p>
			  </div>
			</div>
		  </td>
		</tr>
