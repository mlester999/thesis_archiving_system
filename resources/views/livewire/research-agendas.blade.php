	  ...
	  <table class="min-w-full border-separate divide-y divide-gray-200 border-b-2 shadow">
		<thead class="bg-gray-50 whitespace-nowrap ">
		  ...
		  >
			...
			<th class="font-semibold text-center px-4 text-gray-700 uppercase tracking-normal">Agenda Name
			...
			<th class="font-semibold text-center px-4 text-gray-700 uppercase tracking-normal">Description
		  ...
		  >
			...
			<td class="px-8 whitespace-nowrap ">
				<div class="flex justify-center space-x-2">
					<button wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed" wire:click="view({{ $agenda->id }})" class="cursor-pointer fa-solid fa-eye text-slate-900 hover:text-opacity-70 duration-150 fa-xl"></button>
					<button wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed" wire:click="edit({{ $agenda->id }})" class="cursor-pointer fa-solid fa-pen-to-square text-blue-500 hover:text-opacity-70 duration-150 fa-xl"></button>
					<button wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed" wire:click="disable({{ $agenda->id }})" class="cursor-pointer fa-solid {{ $agenda->agenda_status ? 'fa-user-slash text-red-600' : 'fa-user-check text-green-600' }} hover:text-opacity-70 duration-150 fa-xl"></button>
				</div>
			</td>
		  </tr>
		  @empty
