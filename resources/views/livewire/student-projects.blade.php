    ...
    <div class="flex justify-between">
      <div class="flex flex-col">
        ...
        <div class="flex flex-row">
            <button wire:loading.attr="disabled" wire:loading.class="cursor-not-allowed" wire:click="viewSuggestedTopics()" class="text-slate-50 bg-blue-500 hover:bg-opacity-80 duration-150 rounded-full py-2 px-3 mb-3 ml-2 text-sm">Suggested Topics</button>

            <button x-on:click="show = !show" class="text-blue-500 hover:text-blue-400 duration-150 mb-3 ml-4 text-md mr-auto">
                <template x-if="show">
                <span>Hide </span>
                </template>
    ...
    <div x-show="show" class="w-full max-h-xl p-4 mt-2 mb-4 rounded-lg bg-slate-200 shadow-sm ring-2 ring-gray-300">
        <div class="bg-gray px-4 py-8 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
            ...
            <div class="relative px-8 pt-8 sm:pt-0">
                ...
                <select name="research_agenda" id="research_agenda" class="border-0 shadow-lg mt-2 mb-8 px-3 text-gray-900 rounded-md focus:ring-1 focus:ring-green-500 focus:border-green-500 placeholder:font-sans placeholder:font-light focus:outline-none block w-full">
