<div class="w-full px-6 pb-6 h-screen overflow-y-auto">
	...
	<div class="flex-1 min-w-0 py-2">
		<p class="pb-6 pt-3 font-bold uppercase text-sm leading-7 tracking-wider text-gray-600"><span class="flex items-center gap-1"> <x-ri-home-3-fill class="w-4 h-4" /> Home<x-heroicon-o-arrow-long-right class="w-5 h-6" />Logs<x-heroicon-o-arrow-long-right class="w-5 h-6" />Activity Logs</span></p>
	</div>
		...
		<tbody class="w-full" id="main-table-body">
		  ...
		  >
				<x-table.cell colspan="8">
					...
					@else
					<span class="text-xs md:text-sm">You are currently selecting all <strong>{{ $activities->total() }}</strong> activity logs.</span>
					@endif
				</x-table.cell>
			</x-table.row>
			@endif
		...
		<x-dialog-modal wire:model.defer="showViewModal">
			...
			<x-slot name="content">
				<!--Body-->
					...
					<div class="grid grid-cols-1 lg:grid-cols-3 py-2 space-y-8 lg:space-y-0 text-sm md:text-md">
