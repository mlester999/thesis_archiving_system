	  ...
	  <div class="lg:flex lg:items-center lg:justify-between">
		...
		<div class="mt-4 flex justify-end lg:mt-0 lg:ml-4 z-0">
		  ...
		  <button
			wire:click="create"
			type="button"
			class="text-sm ml-3 mx-auto inline-flex items-center sm:px-4 px-3 py-2 border duration-200 border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-opacity-80 active:outline-none active:ring-2 active:ring-offset-2 active:ring-green-500"
	  ...
	  <table class="min-w-full whitespace-nowrap divide-y divide-gray-200 border-b-2 shadow">
		...
		<tbody class="w-full" id="main-table-body">
		  ...
		  >
			...
			<td class="pl-8">
				<span wire:click="view({{ $curriculum->id }})" class="cursor-pointer px-1 fa-solid fa-eye text-slate-900 hover:text-opacity-70 duration-150 fa-xl"></span>
					<span wire:click="edit({{ $curriculum->id }})" class="cursor-pointer px-1 fa-solid fa-pen-to-square text-blue-500 hover:text-opacity-70 duration-150 fa-xl"></span>
					<span wire:click="delete({{ $curriculum->id }})" class="cursor-pointer pl-1 pr-4 fa-solid fa-trash text-red-500 hover:text-opacity-70 duration-150 fa-xl"></span>
			  </td>
		  </tr>
		  @empty
		  <tr
