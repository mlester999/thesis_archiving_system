...
@endphp
 ...
 <!-- Sidebar -->
    ...
    <div class="flex flex-col p-4 text-gray-500 text-md space-y-3 font-medium">
            ...
            <a href="" class="{{ Route::is('admin.user-list') ? 'bg-revert bg-gray-300 flex text-gray-700 hover:text-gray-700 space-x-2 p-2 hover:bg-gray-200 rounded-md' : 'bg-revert bg-white flex hover:text-gray-700 space-x-2 p-2 hover:bg-gray-200 rounded-md' }}"> <x-radix-activity-log class="w-5 mr-3" /> Activity Logs</a>
        </div>
    </div>