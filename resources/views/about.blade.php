...
<div class="max-w-6xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div class="w-full lg:w-2/5">
        ...
        <img src="{{ asset('images/library_3.jpg') }}" class="rounded-none lg:rounded-t-lg shadow-2xl hidden lg:block">
		<img src="{{ asset('images/library_2.jpg') }}" class="rounded-none lg:rounded-b-lg shadow-2xl hidden lg:block">
