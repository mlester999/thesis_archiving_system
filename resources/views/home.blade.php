...
@section('user')
    ...
    <div class="slider h-screen">
      <div class="slide">
        ...
        <h1 class="absolute font-bold mt-40 text-white text-3xl text-center md:text-5xl lg:text-6xl xl:text-7xl tracking-wider mb-4" style="text-shadow: 2px 1px #000; line-height: 80px;">Theses and Capstone <span class="block">Projects Archiving</span> System</h1>
    </div>
      <div class="slide">
