<x-guest-layout>
    <x-auth-card>
        ...
        <div class="relative max-w-xl flex flex-col mx-12 space-y-10 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:m-0">
        ...
        @endif
            ...
            <form x-data="{ buttonDisabled: false }" x-on:submit="buttonDisabled = true" method="POST" action="{{ route('verification.send') }}">
                @csrf
